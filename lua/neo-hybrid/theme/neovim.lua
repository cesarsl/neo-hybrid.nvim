...
M.highlights = {
  ...
  Cursor = { guibg = palette.normal.bg, guifg = palette.normal.fg },
  lCursor = { guibg = palette.normal.bg, guifg = palette.normal.fg },
  Normal = { guibg = palette.normal.bg, guifg = palette.normal.fg },
  FloatBorder = { guibg = palette.normal.black, guifg = palette.normal.black },
  ...
  Constant = { guifg = palette.bright.green },
  Number = { guifg = palette.normal.red },
  Identifier = { guifg = palette.normal.blue },
  Statement = { gui = "none", guifg = palette.normal.fg },
  PreProc = { guifg = palette.normal.magenta },
  Type = { gui = "none", guifg = palette.bright.green },
  Special = { guifg = palette.normal.white },
