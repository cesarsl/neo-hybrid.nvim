...
M.highlights = {
  ...
  DiagnosticSignError = { guibg = color.black.dimmed },
  DiagnosticSignWarn = { guibg = color.black.dimmed },
  DiagnosticSignInfo = { guibg = color.black.dimmed },
  DiagnosticSignHint = { guibg = color.black.dimmed },
