...
M = {
  highlights = {
    ...
    NonText = {
      gui = "bold",
      guifg = color.blue.dimmed,
    },
    Directory = {
      guifg = color.cyan.bright,
    },
    ErrorMsg = {
      guibg = color.red.normal,
      guifg = color.white.bright,
    },
    IncSearch = {
      gui = "reverse",
    },
    Search = {
      guibg = color.yellow.bright,
      guifg = color.black.normal,
    },
    MoreMsg = {
      gui = "bold",
      guifg = color.green.bright,
    },
    ModeMsg = {
      gui = "bold",
    },
    LineNr = {
      guifg = color.yellow.bright,
    },
    CursorLineNr = {
      gui = "bold",
      guifg = color.yellow.bright,
    ...
    VertSplit = {
      gui = "none",
      guibg = color.bg.normal,
      guifg = color.black.dimmed,
    },
    Title = {
      gui = "bold",
      guifg = color.magenta.bright,
    },
    Visual = {
      guibg = color.white.dimmed,
    },
    WarningMsg = {
      guifg = color.red.bright,
    },
    WildMenu = {
      guibg = color.yellow.bright,
      guifg = color.black.normal,
    ...
    Folded = {
      guibg = color.black.normal,
      guifg = color.cyan.dimmed,
    },
    FoldColumn = {
      guibg = color.black.dimmed,
      guifg = color.cyan.dimmed,
    ...
    DiffAdd = {
      guibg = color.blue.dimmed,
    },
    DiffChange = {
      guibg = color.magenta.dimmed,
    },
    DiffDelete = {
      gui = "bold",
      guibg = color.cyan.dimmed,
      guifg = color.blue.bright,
    },
    DiffText = {
      gui = "bold",
      guibg = color.red.dimmed,
    },
    SignColumn = {
      guibg = color.black.dimmed,
      guifg = color.blue.normal,
    },
    Conceal = {
      guibg = color.white.dimmed,
      guifg = color.white.normal,
    },
    SpellBad = {
      gui = "undercurl",
      guisp = color.red.normal,
    },
    SpellCap = {
      gui = "undercurl",
      guisp = color.blue.normal,
    },
    SpellRare = {
      gui = "undercurl",
      guisp = color.magenta.normal,
    },
    SpellLocal = {
      gui = "undercurl",
      guisp = color.yellow.bright,
    },
    Pmenu = {
      guibg = color.black.dimmed,
    },
    PmenuSel = {
      guibg = color.bg.bright,
    },
    PmenuSbar = {
      guibg = color.black.bright,
    },
    PmenuThumb = {
      guibg = color.white.dimmed,
    },
    ...
    RedrawDebugComposed = {
      guibg = color.green.bright,
    },
    RedrawDebugRecompose = {
      guibg = color.red.bright,
    },
    Cursor = {
      guibg = color.bg.normal,
      guifg = color.fg.normal,
    },
    lCursor = {
      guibg = color.bg.normal,
      guifg = color.fg.normal,
    ...
    Special = {
      guifg = color.yellow.dimmed,
    },
    DiagnosticError = {
      guifg = color.red.normal,
    },
    DiagnosticWarn = {
      guifg = color.yellow.normal,
    },
    DiagnosticInfo = {
      guifg = color.blue.normal,
    },
